...
# Visualize geodesic distance matrix optional
...
#3 Now apply classical Multidimensional Scaling to embed the datapoints into a 2D line graph that preserves the intrinsic (geodesic) distances among the points. Call it "mds_2d"
...
#4 Observe how the geodesic distances are preserved in a 2D embedding of 4096D points that likely forms a 2D manifold.

```{r}
# Classical MDS to 2D
coords_2d <- mds_2d$points
...
# Isomap with k-nearest neighbors (e.g., k = 5) and 2D embedding
num_neighbors = 
cats_isomap_result <- isomap(dist(image_matrix), k = num_neighbors, ndim = 10)
...
#5 Think about why different values of k (number of nearest neighbors) affect the variance explained by different dimensions.
